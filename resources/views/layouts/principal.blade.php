...
<header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item">
                <img alt="..." src="{{ asset('img/principal/6.jpg') }}" width="100%" height="100%" class="media-object">
                <div class="carousel-caption d-none d-md-block text-left">
                    <img alt="..." src="{{ asset('img/principal/logo.png') }}" width="15%" height="15%" class="media-object">
                </div>
            </div>
            <div class="carousel-item">
                <img alt="..." src="{{ asset('img/principal/8.jpg') }}" width="100%" height="100%" class="media-object">
                <div class="carousel-caption d-none d-md-block text-left">
                    <img alt="..." src="{{ asset('img/principal/logo.png') }}" width="15%" height="15%" class="media-object">
                </div>
            </div>
            <div class="carousel-item">
                <img alt="..." src="{{ asset('img/principal/9.jpg') }}" width="100%" height="100%" class="media-object">
                <div class="carousel-caption d-none d-md-block text-left">
                    <img alt="..." src="{{ asset('img/principal/logo.png') }}" width="15%" height="15%" class="media-object">
                </div>
            </div>
            <div class="carousel-item">
                <img alt="..." src="{{ asset('img/principal/10.jpg') }}" width="100%" height="100%" class="media-object">
                <div class="carousel-caption d-none d-md-block text-left">
                    <img alt="..." src="{{ asset('img/principal/logo.png') }}" width="15%" height="15%" class="media-object">
                </div>
            </div>
